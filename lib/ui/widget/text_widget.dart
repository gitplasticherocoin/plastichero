...
class InputTextField extends StatefulWidget {
  ...
  const InputTextField({
    ...
    this.hintColor = const Color(ColorTheme.c_767676),
...
// TODO: InputAuthCodeTextField
class InputAuthCodeTextField extends StatefulWidget {
  final TextInputAction? textInputAction;
  final int? maxLength;
  final bool enabled;
  final String? hintText;
  ...
  @override
  State<StatefulWidget> createState() {
    return InputAuthCodeTextFieldState();
  }
}

class InputAuthCodeTextFieldState extends State<InputAuthCodeTextField> {
  late final TextEditingController controller;
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      cursorColor: const Color(ColorTheme.appColor),
      decoration: InputDecoration(
        contentPadding: widget.contentPadding ?? const EdgeInsets.only(left: 17.0, top: 18.0, right: 17.0, bottom: 18.0),
        isCollapsed: true,
        filled: true,
        ...
        errorStyle: TextStyle(
          height: 1.2,
          fontSize: 14.0,
          color: widget.isError ? const Color(ColorTheme.c_ff4242) : const Color(ColorTheme.appColor),
          fontFamily: Setting.appFont,
          fontWeight: FontWeight.w400,
        ),
        hintStyle: const TextStyle(
          fontSize: 14.0,
          color: Color(ColorTheme.c_b1b1b1),
          fontFamily: Setting.appFont,
          fontWeight: FontWeight.w400,
        ),
        ...
        focusedErrorBorder: OutlineInputBorder(
          ...
          borderSide: const BorderSide(
            width: 1,
            color: Color(ColorTheme.c_ff4242),
          ),
        ),
